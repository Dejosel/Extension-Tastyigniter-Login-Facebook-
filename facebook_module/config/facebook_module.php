...
$config['extension_meta'] = array(
	...
	'author'      => 'Dejosel',
	'description' => 'This extension will allow you to login with facebook SDK module around your website.',
	'settings'    => TRUE,
);
...
$config['extension_permission'] = array(
	'name'        => 'Module.FacebookModule',
	'action'      => array('manage'),
	'description' => 'Ability to manage Facebook module',
);
